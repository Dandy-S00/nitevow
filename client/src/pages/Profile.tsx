  ...
  const upload = async (event: ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      for (const file of files) {
        ...
        const response = await fetch("/api/profile-media", { method: "POST", headers: { "Content-Type": file.type }, body: file });
